...
(isset($_GET['lang'])?$langue=$_GET['lang']:$langue=DEFAULT_LANGUAGE);
i18n_init($langue);

if (file_exists('constant.php')) {
    die(_t('ALREADY_INSTALL'));
}
...
<head>
    ...
    <title><? echo _t('INSTALL_TITLE') ?></title>
...
<div class="global-wrapper">
    ...
    <div id="main-container">
        ...
        <div id="menuBar">
        <aside>
            <h3 class="left"><? echo _t('INSTALL_PRE_REQUIS') ?></h3>
    ...
    <form action="install.php" method="POST" class="install">
        <h1><? echo _t('INSTALL_TITLE') ?></h1>
        <h2><? echo _t('INSTALL_TAB_GENERAL') ?></h2>
        <ul>
            <li>
                <span><? echo _t('INSTALL_LANGUAGE') ?></span>
            ...
            <li>
                <span><? echo _t('PROJECT_ROOT') ?></span>
                <input type="text" name="root" value="<?php echo $root; ?>">
            </li>
        </ul>
        <h2><? echo _t('INSTALL_TAB_BDD') ?></h2>
        <ul>
            <li>
                <span><? echo _t('INSTALL_HOST') ?></span>
                <input type="text" name="mysqlHost" value="<?php echo $mysqlHost; ?>" placeholder="<? echo _t('INSTALL_COMMENT_HOST') ?>">
            </li>
            <li>
                <span><? echo _t('LOGIN') ?></span>
                <input type="text" name="mysqlLogin" value="<?php echo $mysqlLogin; ?>">
            </li>
            <li>
                <span><? echo _t('PASSWORD') ?></span>
                <input type="text" autocomplete="off" name="mysqlMdp" value="<?php echo $mysqlMdp; ?>" placeholder="<? echo _t('INSTALL_DISPLAY_CLEAR') ?>">
            </li>
            <li>
                <span><? echo _t('INSTALL_BDD') ?></span>
                <input type="text" name="mysqlBase" value="<?php echo $mysqlBase; ?>" placeholder="<? echo _t('INSTALL_COMMENT_BDD') ?>">
            </li>
            <li>
                <span><? echo _t('INSTALL_PREFIX_TABLE') ?></span>
                <input type="text" name="mysqlPrefix" value="<?php echo $mysqlPrefix; ?>">
            </li>
        </ul>
        <h2><? echo _t('INSTALL_TAB_ADMIN') ?></h2>
        <ul>
            <li>
                <span><? echo _t('LOGIN') ?></span>
                <input type="text" name="login" value="<?php echo $login; ?>" placeholder="<? echo _t('LOGIN') ?>">
            </li>
            <li>
                <span><? echo _t('PASSWORD') ?></span>
                <input type="text" autocomplete="off" name="password" value="<?php echo $password; ?>" placeholder="<? echo _t('INSTALL_DISPLAY_CLEAR') ?>">
            </li>
        </ul>
        <button id="installButton" name="installButton"><? echo _t('INSTALL_BTN') ?></button>
    </form>
</div>
<div id="footer-container">
    <footer class="wrapper">
