    ...
    case 'synchronize':
        ...
        foreach ($feeds as $feed) {
            ...
            if ($commandLine) {
                ...
                echo "<dt><a href='settings.php#".$feed->getId()."' onClick=\"javascript:self.location.href='settings.php#".$feed->getId()."';self.location.reload();\">"._t('MODIFY')."</a> | <i>{$parseTimeStr}s</i> | <a href='{$feedUrl}'>{$feedName}</a></dt>\n";
