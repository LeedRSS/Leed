...
// 			error_log('(56a7ezr) get_title()='.$item->get_title());
			...
			$event->setContent(
				html_entity_decode($item->get_content(), ENT_COMPAT, 'UTF-8')
				.html_entity_decode($enclosure, ENT_COMPAT, 'UTF-8')
			);
			$event->setDescription(
				html_entity_decode($item->get_description(), ENT_COMPAT, 'UTF-8')
				.html_entity_decode($enclosure, ENT_COMPAT, 'UTF-8')
			);
